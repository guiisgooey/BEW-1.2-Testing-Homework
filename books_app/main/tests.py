...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name' :'Andrew Wagner',
            'biography':'Make School class of 2022'
        }

        self.app.post('/create_author', data=post_data)
        created_author = Author.query.filter_by(name='Andrew Wagner')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='Choose Your Own Adventure')
        self.assertIsNotNone(created_genre)

    def test_profile_page(self):
        """Test creating a profile page."""
        create_books()
        create_user()
        login(self.app, 'me1', 'password')
    ...
    def test_unfavorite_book(self):
        """Test making a favorite book no longer a favorite"""
        create_books()
        create_user()
        login(self.app, 'me1', 'password')
